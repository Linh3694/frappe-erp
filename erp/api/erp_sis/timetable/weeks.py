...
def get_teacher_week():
    ...
    try:
        ...
        # Để frontend có thể match entries với periods mới dựa trên priority (giống get_class_week)
        try:
            ...
            frappe.logger().info(f"📊 [Teacher Week] Enriched {len(period_info_map)} periods with priority info for entries")
