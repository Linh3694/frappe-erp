...
# NOTE (tạm tắt theo yêu cầu):
# API cập nhật hàng loạt toàn bộ danh mục về "Phòng lớp học" đã được comment để tránh thao tác nhầm.
# Khi cần bật lại, bỏ comment toàn bộ block bên dưới.
#
# @frappe.whitelist(allow_guest=False)
